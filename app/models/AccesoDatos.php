...
class AccesoDatos {
   ...
   // Constructor privado  Patron singleton
    ...
    public function getClientes ($primero,$cuantos,$filtro):array {
        $tuser = [];
        // Crea la sentencia preparada
       // echo "<h1> $primero : $cuantos  </h1>";
       //Añado el filtro en la consulta mediante un order by, por defecto viene por el nombre
        $stmt_usuarios  = $this->dbh->prepare("select * from Clientes order by $filtro limit $primero,$cuantos");
    ...
    //Añado una función para encontrar el último ID de la base de datos
    ...
    //Añado la consulta para comprobar el email
